...
try:
    driver.get("http://localhost:5005/addfriend")
    time.sleep(2)

    print("--= Beginning Tests =--")
    add_friend_button = driver.find_element(By.CSS_SELECTOR, "button[type='submit'][value='Submit']")
    add_friend_input_form = driver.find_element(By.CSS_SELECTOR, "input[class='form-control']")
    add_friend_input_form_name = driver.find_element(By.CSS_SELECTOR, "p[class='card-body'] h3.card-title").text
